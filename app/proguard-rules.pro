...
-keep,includedescriptorclasses class cn.xihan.fridahooker.**$$serializer { *; }
-keepclassmembers class cn.xihan.fridahooker.** {
    *** Companion;
}
-keepclasseswithmembers class cn.xihan.fridahooker.** {
